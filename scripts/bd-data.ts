...
import { ACCESS_RIGHT, DEPOSIT_STATUS, DepositDocument, DepositSchema, PUBLICATION_TYPE, REVIEW_TYPE } from '../src/deposit/deposit.schema';
import { environment } from '../src/environments/environment';
import { USER_TYPE, UserDocument, UserSchema } from '../src/users/user.schema';
import { DisciplineDocument, DisciplineSchema } from '../src/discipline/discipline.schema';
import { disciplines } from './disciplines';

const DepositModel = mongoose.model<DepositDocument>(DepositDocument.name, DepositSchema);
const UserModel = mongoose.model<UserDocument>(UserDocument.name, UserSchema);
const DisciplineModel = mongoose.model<DisciplineDocument>(DisciplineDocument.name, DisciplineSchema);
